...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_moveShape_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_moveShape_t qt_meta_stringdata_moveShape = {
    {
QT_MOC_LITERAL(0, 9), // "moveShape"
QT_MOC_LITERAL(10, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(32, 0) // ""

    },
    "moveShape\0on_buttonBox_accepted\0"
};
...
void moveShape::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<moveShape *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject moveShape::staticMetaObject = { {
    ...
    qt_meta_stringdata_moveShape.offsetsAndSize,
    qt_meta_data_moveShape,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_moveShape_t
, QtPrivate::TypeAndForceComplete<moveShape, std::true_type>
