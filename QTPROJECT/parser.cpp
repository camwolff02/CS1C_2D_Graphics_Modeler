...
myStd::vector<Shape*> Parser::parse(QString filename)
{
    ...
    while (!in.atEnd()) {  // while we are not at file end
        ...
        if (type == "Text") {
            ...
            int alignment = getAlignment(in.readLine().remove(0, 15));
...
// HELPER FUNCTIONS
Qt::BrushStyle Parser::getBrushStyle(QString style)
{
...
Qt::PenCapStyle Parser::getPenCapStyle(QString style)
{
...
Qt::PenStyle Parser::getPenStyle(QString style)
{
...
Qt::PenJoinStyle Parser::getPenJoinStyle(QString style)
{
...
int Parser::getAlignment(QString alignment)
{
    if (alignment == "AlignRight") return 2;
    else if (alignment == "AlignHCenter") return 4;
    else if (alignment == "AlignJustify") return 8;
    else if (alignment == "AlignAbsolute") return 16;
    else if (alignment == "AlignHorizontal_Mask") return 31;
    else if (alignment == "AlignBottom") return 64;
    else if (alignment == "AlignCenter") return 132;
    else if (alignment == "AlignBaseline") return 256;
    else return 1;
}

QFont Parser::makeFont(QString fontFamily, int pointSize, QString fontWeight, QString fontStyle)
{
